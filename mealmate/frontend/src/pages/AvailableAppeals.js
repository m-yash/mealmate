                  ...
                  <TableBody>
                    {currentPageData.map((appeal) => (
                      <TableRow key={appeal._id}>
                        ...
                        <TableCell>
                          <span className="text-sm">
                            {typeof appeal.chefRating === 'number' ? appeal.chefRating.toFixed(1) : appeal.chefRating}
                          </span>
                        </TableCell>
                        <TableCell>
                          <Button size="small" onClick={() => handleResponse(appeal._id, 'accept', requestId, appeal.chef_id._id)}>Accept</Button>
                          {/* <Button onClick={() => handleResponse(appeal._id, 'reject')} layout="link">Reject</Button> */}
                        </TableCell>
                      </TableRow>
                    ))}
