...
// actiontable make a copy of the data, for the second table
...
function Dashboard() {
  ...
  // actiontable setup pages control for every table
  // actiontable setup data for every table
  ...
  // actiontable pagination change control
